<div id="help-template" class="outer">
    ...
    <p><span style="font-family: Arial, sans-serif; font-size: 172%; "><a href="https://xoops.org/modules/newbb/viewforum.php?forum=28" target="_blank">XOOPS Support Forums</a><br></span>
    </p>
